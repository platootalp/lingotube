...
@Getter
@Setter
@TableName("ums_user_video_browse_history")
@ApiModel(value = "UmsUserVideoBrowseHistory对象", description = "用户浏览视频历史记录表")
public class UmsUserVideoBrowseHistory implements Serializable {
