...
@Getter
@Setter
@TableName("ums_user_watch_later_video")
@ApiModel(value = "UmsUserWatchLaterVideo对象", description = "稍后再看视频表")
public class UmsUserWatchLaterVideo implements Serializable {
