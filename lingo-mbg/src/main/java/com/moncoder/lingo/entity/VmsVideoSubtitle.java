 ...
 *
 * @author moncoder
 * @since 2024-03-20 16:27:26
 */
@Getter
@Setter
@TableName("vms_video_subtitle")
@ApiModel(value = "VmsVideoSubtitle对象", description = "")
public class VmsVideoSubtitle implements Serializable {
